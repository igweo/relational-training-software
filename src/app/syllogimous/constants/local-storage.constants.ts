...
export const LS_SPEECH_MODE = "SYL_SPEECH_MODE";
export const LS_VISUAL_MODE = "SYL_VISUAL_MODE";
export const LS_IMAGE_MODE = "SYL_IMAGE_MODE";
export const LS_GRAPH_ARRANGEMENT_MODE = "SYL_GRAPH_ARRANGEMENT_MODE";
export const LS_SPATIO_TEMPORAL_MODE = "SYL_SPATIO_TEMPORAL_MODE";
export const LS_INCLUSION_EXCLUSION_ONLY_MODE = "SYL_INCLUSION_EXCLUSION_ONLY_MODE";
export const LS_SCORE = "SYL_SCORE";
export const LS_HIDE_INSTRUCTIONS = "SYL_HIDE_INSTRUCTIONS";
export const LS_AUTO_CAROUSEL = "SYL_AUTO_CAROUSEL";
...
export const LS_PROPS = [
    ...
    LS_SCORE,
    LS_SPATIO_TEMPORAL_MODE,
    LS_INCLUSION_EXCLUSION_ONLY_MODE,
    LS_IMAGE_MODE,
    LS_AUTO_CAROUSEL,
];
