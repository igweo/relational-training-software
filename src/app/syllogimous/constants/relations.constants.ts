...
export const RELATIONS: Record<RelationKey, Entry> = {
    ...
    [RelationKey.GreaterThan]: { opposite: RelationKey.LessThan, domains: ["numerical"], asPP: ["greater than", "higher than", "in excess of", "more than"], asVerb: ["exceeds", "outweighs", "surpasses"] },
